...
const hero = () => {
  return (
    <div>
      <div className="relative bg-[#F2F0FF] p-8 flex items-center justify-between">
             {/* images 1 */}
             <div className="absolute top-0 ml-0 w-1/6">
          <Image src={Lamp} alt="Lamp" width={300} height={500} />
        </div>
      <div className="w-1/3 mt-10 ml-36 pl-10  ">
         
        <div className="mb-4 ">
          <span className="text-[#FB2E86]">Best Furniture For Your Castle...</span>
        </div>
        <h1 className="text-4xl font-bold mb-4">New Furniture Collection Trends in 2020</h1>
        <p className="text-gray-500 mb-6">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in
          pharetra massa in justo.
        </p>
